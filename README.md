...
**This document describes version 0.9.12 of this plugin. The newest, experimental version 0.10.2 with a new configuration syntax has not yet much documentation, so please stick to 0.9.12 in the meantime.**
