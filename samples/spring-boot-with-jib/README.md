...
[INFO] Building Docker Maven Plugin :: Spring Boot JIB 0.39-SNAPSHOT
[INFO] --------------------------------[ jar ]---------------------------------
[INFO] 
[INFO] --- docker-maven-plugin:0.39-SNAPSHOT:build (default-cli) @ dmp-sample-spring-boot-jib ---
...
[WARNING] Cannot include project artifact: io.fabric8.dmp.samples:dmp-sample-spring-boot-jib:jar:0.39-SNAPSHOT; it doesn't have an associated file or directory.
...
JIB> 		/home/rohaan/work/repos/docker-maven-plugin/samples/spring-boot-with-jib/target/docker/rohankanojia/spring-boot-dmp-sample-jib/build/maven/dmp-sample-spring-boot-jib-0.39-SNAPSHOT.jar
JIB> 	:                                                                                                                      
...
JIB> Container program arguments set to [java, -jar, /maven/dmp-sample-spring-boot-jib-0.39-SNAPSHOT.jar]                    
...
[INFO] --------------------------------[ jar ]---------------------------------
[INFO] 
[INFO] --- docker-maven-plugin:0.39-SNAPSHOT:push (default-cli) @ dmp-sample-spring-boot-jib ---
...
JIB> Containerizing application with the following files:                                                                    
JIB> Retrieving registry credentials for registry-1.docker.io...                                                             
JIB> Container program arguments set to [java, -jar, /maven/dmp-sample-spring-boot-jib-0.39-SNAPSHOT.jar] (inherited from base image)
...
JIB> 		/home/rohaan/work/repos/docker-maven-plugin/samples/spring-boot-with-jib/target/docker/rohankanojia/spring-boot-sample/build/my-project-assembly/dmp-sample-spring-boot-jib-0.39-SNAPSHOT.jar
JIB> 	:                                                                                                                      
...
JIB> Retrieving registry credentials for registry-1.docker.io...                                                             
JIB> Using base image with digest: sha256:92530aa1eb4c49e3b1d033f94e9cd4dc891d49922459e13f84e59c9d68d800eb                   
JIB> Container program arguments set to [java, -jar, /my-project-assembly/dmp-sample-spring-boot-jib-0.39-SNAPSHOT.jar]      
JIB> Building image to tar file...                                                                                           
JIB> [========================      ] 80.0% complete > writing to tar file
JIB> [==============================] 100.0% complete
...
JIB> Containerizing application with the following files:                                                                    
JIB> Retrieving registry credentials for registry-1.docker.io...                                                             
JIB> Container program arguments set to [java, -jar, /my-project-assembly/dmp-sample-spring-boot-jib-0.39-SNAPSHOT.jar] (inherited from base image)
...
dmp-sample-spring-boot-jib-0.39-SNAPSHOT.jar  static
