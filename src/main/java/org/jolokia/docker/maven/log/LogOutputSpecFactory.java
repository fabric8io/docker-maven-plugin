...
public class LogOutputSpecFactory {
    ...
    private void addLogFormat(LogOutputSpec.Builder builder, org.jolokia.docker.maven.config.LogConfiguration logConfig) {
    ...
    private org.jolokia.docker.maven.config.LogConfiguration extractLogConfiguration(ImageConfiguration imageConfiguration) {
        ...
        if (logConfig == null) {
            logConfig = org.jolokia.docker.maven.config.LogConfiguration.DEFAULT;
        }
        return logConfig;
    }
}
