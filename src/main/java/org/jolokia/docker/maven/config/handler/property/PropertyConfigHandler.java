...
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ALIAS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ASSEMBLY_BASEDIR;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ASSEMBLY_DESCRIPTOR;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ASSEMBLY_DESCRIPTOR_REF;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ASSEMBLY_DOCKER_FILE_DIR;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ASSEMBLY_EXPORT_BASEDIR;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ASSEMBLY_IGNORE_PERMISSIONS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ASSEMBLY_MODE;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ASSEMBLY_USER;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.BIND;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.CAP_ADD;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.CAP_DROP;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.CLEANUP;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.CMD;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.DNS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.DNS_SEARCH;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.DOMAINNAME;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ENTRYPOINT;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ENV;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.ENV_PROPERTY_FILE;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.EXTRA_HOSTS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.FROM;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.HOSTNAME;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.LABELS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.LINKS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.MAINTAINER;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.MEMORY;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.MEMORY_SWAP;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.NAME;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.NAMING_STRATEGY;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.NOCACHE;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.OPTIMISE;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.PORTS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.PORT_PROPERTY_FILE;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.POST_START;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.PRE_STOP;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.PRIVILEGED;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.REGISTRY;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.RESTART_POLICY_NAME;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.RESTART_POLICY_RETRY;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.RUN;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.TAGS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.USER;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.VOLUMES;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.VOLUMES_FROM;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_HTTP_METHOD;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_HTTP_STATUS;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_HTTP_URL;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_KILL;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_LOG;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_SHUTDOWN;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_TCP_HOST;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_TCP_PORT;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_TIME;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WAIT_URL;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WATCH_INTERVAL;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WATCH_POSTGOAL;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WORKDIR;
import static org.jolokia.docker.maven.config.handler.property.ConfigKey.WORKING_DIR;
