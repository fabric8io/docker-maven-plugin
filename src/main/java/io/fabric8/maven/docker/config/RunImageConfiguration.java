...
public class RunImageConfiguration {
    ...
    /**
     * Environment variables to set when starting the container. key: variable
     * name, value: env value
     */
    @Parameter
	...
	public Builder namingStrategy(String namingStrategy) {
	    config.namingStrategy = namingStrategy == null ? NamingStrategy.none
