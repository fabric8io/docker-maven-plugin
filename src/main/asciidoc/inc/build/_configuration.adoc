...
| *shellParams*
| Shell to be used for the *runCmds*. It contains *shell* elements which are defining the executable and its params. Whitespace is trimmed from each element and empty elements are ignored.
