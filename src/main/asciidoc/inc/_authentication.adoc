...
You can use any IAM access key with the necessary permissions in all of the ways mentioned above except docker login. Use the IAM **Access key ID** as the username and the **Secret access key** as the password.
