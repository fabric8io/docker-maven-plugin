...
This allows you to make use of all link:https://docs.aws.amazon.com/sdk-for-java/v1/developer-guide/credentials.html[the options the default credential provider chain provides].
