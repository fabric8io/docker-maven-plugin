...
//        ExternalImageConfiguration extConfig = new ExternalImageConfiguration.Builder().properties(propsConfig).build();
//        ImageConfiguration config = new ImageConfiguration.Builder().name("image").alias("alias").externalConfig(extConfig).build();
//
